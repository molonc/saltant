...
def get_azure_logs_for_task_instance(job_uuid):
    ...
    container_client = ContainerClient(account_url="https://"+os.environ["AZURE_STORAGE_ACCOUNT_NAME"]+".blob.core.windows.net/", container_name=os.environ["AZURE_LOGS_CONTAINER_NAME"], credential=os.environ["AZURE_STORAGE_ACCOUNT_KEY"])
